...
<div class="container">
	<div class="card main-panel-danger">
		...
		<div class="main-panel-content card-block">
			<p class="card-text">Voulez vous vraiment supprimer le jeu ${game.wording} ?</p>
			<div class="card-footer">
				...
				<div class="list-group">
					...
					<c:forEach var="mission" items="${game.inscriptions}">
						<a class="list-group-item" href="detailsMission.htm?id=${mission.id}">
							${mission.wording}
						</a>
					</c:forEach>
				</div>				
			...
			<div class="buttons-group">
				<a href="detailsGame.htm?id=${game.id}" class="btn btn-primary">
					Annuler
				</a>
				<a href="deleteValidateGame.htm?id=${game.id}" class="btn btn-danger">
					Supprimer
				</a>
			</div>
		</div>
